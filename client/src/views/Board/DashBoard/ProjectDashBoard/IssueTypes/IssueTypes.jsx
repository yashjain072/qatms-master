        ...
        <Block style={{ marginRight: '20px' }}>
          <IconContainer>
            <Icon
              ...
              size={18}
              style={{
                backgroundColor: 'rgba(79, 173, 230, .2)',
          ...
          <BlockContent>
            <Number>
              {
                tickets.filter((ticket) => ticket.issueType === IssueTypes.TASK)
                  .length
              }
            </Number>
        ...
        <Block>
          <IconContainer>
            <Icon
              ...
              size={18}
              style={{
                backgroundColor: 'rgba(228, 77, 66, .2)',
                color: 'rgb(228, 77, 66)',
              }}
            ></Icon>
          </IconContainer>
          <BlockContent>
            <Number>
              {
                tickets.filter((ticket) => ticket.issueType === IssueTypes.BUG)
                  .length
              }
            </Number>
        ...
        <Block style={{ marginRight: '20px' }}>
          <IconContainer>
            <Icon
              ...
              size={20}
              style={{
                backgroundColor: 'rgba(101, 186, 67, .2)',
          ...
          <BlockContent>
            <Number>
              {
                tickets.filter(
                  (ticket) => ticket.issueType === IssueTypes.STORY
                ).length
              }
            </Number>
        ...
        <Block>
          <IconContainer>
            <Icon
              ...
              size={20}
              style={{
                backgroundColor: 'rgba(101, 84, 192, .2)',
